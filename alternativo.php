...
<body>
		...
		<div class="container">
			...
			<div class="interaction">
				...
				<div class="visit">
					...
					<button type="submit">Voltar ao site</button>
				</div>
				<div class="playit">
	...
	<audio id="audio" src="https://sonic.dedicado.stream/8090/stream"></audio>
    <script>
    ...
    <script src="https://api2.truesecurity.com.br/truePlayer.js/sonic.dedicado.stream/8090/audio?t=1585214756"></script>
</body>
</html>